...
const OPM_OPTIONS = [
    { texto: '1º SGB - Comando', codigo: '704091000' },
    { texto: '1º SGB - Administração', codigo: '704091800' },
    { texto: '1ª EB Jd. Independência', codigo: '704091101' },
    { texto: '2ª EB Campos Elíseos', codigo: '704091102' },
    { texto: '3ª EB Ipiranga', codigo: '704091103' },
    { texto: '4ª EB Batatais', codigo: '704091104' },
    { texto: '2º PB Irajá', codigo: '704091200' },
    { texto: '1ª EB Irajá', codigo: '704091201' },
    { texto: '2ª EB Lagoinha', codigo: '704091202' },
    { texto: '3º PB Bebedouro', codigo: '704091300' },
    { texto: '1ª EB Bebedouro', codigo: '704091301' },
    { texto: '4º PB Sertãozinho', codigo: '704091400' },
    { texto: '1ª EB Sertãozinho', codigo: '704091401' },
    { texto: '2ª EB Jaboticabal', codigo: '704091402' }
];
...
async function salvarModerador(event) {
    ...
    try {
        ...
        await set(ref(database, `Solic_Moderador/${re}`), dados);
...
function carregarModeradores() {
    onValue(ref(database, 'Solic_Moderador'), snapshot => {
